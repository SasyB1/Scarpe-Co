    ...
    public class ProductService : IProductService
    {
        private static List<Prodotto> products = new List<Prodotto>
        {
             ...
             new Prodotto
            {
                ...
                Descrizione = "Scarpe da maranza per uomo",
                Prezzo = 115,
              ...
              new Prodotto
            {
                ...
                Descrizione = "Scarpe da maranzina per donna",
                Prezzo = 57,
               ...
               new Prodotto
            {
                ...
                Descrizione = "Scarpe da musicista in carriera",
                Prezzo = 88,
              ...
              new Prodotto
            {
                ...
                Descrizione = "Scarpe da donna con gusti discutibili",
                Prezzo = 25,
